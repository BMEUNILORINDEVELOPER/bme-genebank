  ...
  return (
    <>
        <div className="my-mother bg-color-code-2 my-bottom-50 xs-down-6 down-4">
          <div className="my-col-10 xs-10 textleft off-1 xs-down-5 down-5">
            <div className="my-col-4 xs-8">
              <div className="my-col-4 xs-off-3"><img className="biologo" src={biologo} alt="" /></div>
              <div className="down-20 genetext px12 off-1">To create a genomic database that would facilate
            ...
            <div className="my-col-3 xs-down-4 px13">
              <div className="my-col-10  xs-down-4 xs-10 off-2">
                ...
                <div className="px12 down-5 bold"><i className="fas fa-map-marker-alt"></i> P.M.B 1515</div>
                <div className="xs-down-1 down-3 px12 bold">Biomedical Engineering Department, University of Ilorin, Ilorin, Nigeria</div>
                <div className="xs-down-1 down-3 px12"><i className="fas fa-envelope"></i> bmeilorin@gmail.com</div>
              </div>
            </div>
            <div className="my-col-4 xs-down-4 px12">
